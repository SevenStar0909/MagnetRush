...
public class EnemyBossSettings : ScriptableObject
{
    ...
    [LabelRange("本体に1発当てたときのスタンゲージ蓄積率（％）", 1, 100)]
    ...
    [Label("追跡範囲（m）")]
    [Tooltip("noUse_プレイヤーを追跡する範囲（m）")]
    public float chaseRange = 20f;
    [Label("停止距離（m）")]
    [Tooltip("no_useプレイヤーとの停止距離（m）")]
    ...
    [LabelRange("タックル時の速度倍率", 0.5f, 5.0f)]
